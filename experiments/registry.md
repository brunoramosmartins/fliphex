...
|---|---:|---:|---:|
| 3×3 | 711,963 | 23,371 | **3.2826%** |
| 5×3 | 17,506,580,337 | 60,009,757 | **0.3428%** |
| **5×5 (shipped)** | 488,676,694,181,949,003 | 38,814,863,794,591 | **0.0079%** |

The sum runs from `t = 1`, not `t = 0`. Layer 0 is the opening position: the
identity calls it an orphan because it has no predecessor, and it is reachable
by definition. Off by one on every board, and the 3×3 is where it is visible —
23,371 is the figure EXP-005's pilot returned, and 23,372 is what the unguarded
sum gives.
